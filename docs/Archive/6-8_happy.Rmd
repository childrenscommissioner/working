...
knitr::opts_chunk$set(echo = F, warning=F,message = F,optipng = '-o7')
...
<div>
<div class="stat_box">
<p style="color: white;">Key stat 1</p>
</div>

<div class="stat_box">
<p style="color: white;">Key stat 2</p>
</div>
...
dat<-copy(df_happy)[,value:=ifelse(value %in% dk_vals,NA,
                        ifelse(value %in% c("Unhappy","Very unhappy","sad"),"Sad",
                               ifelse(
...
<h3>What combinations of items are children unhappy about</h3>
