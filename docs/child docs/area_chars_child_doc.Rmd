...
<div id="idaci_v" class="sect area">

```{r, results='asis'}


df_idaci<-table_f("idacivigintile")[!is.na(idacivigintile) & !is.na(value) # reshape data
                                  ]

two_way_tb_f(df_idaci,"idacivigintile","Highest vs lowest",col1,
             mult_cols=T,test_vals=c(1,10),
             columnGroups = list(colGroup(name="IDACI vigintile (1 = most deprived)",as.character(c(1:10))))
             ) # create table - comparison is between 1st and 10th decile
