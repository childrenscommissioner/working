...
df_idaci<-table_f("idaci_decile")[!is.na(idaci_decile) & !is.na(value) # reshape data
                                  ]
...
df_age<-table_f("covid_quintile",df_use=df)[!is.na(covid_quintile)] # reshape data
...
df_age<-table_f("loss10")[!is.na(loss10)] # reshape data
...
df_age<-table_f("obese_rate",df[!is.na(obese_rate)]) # reshape data
