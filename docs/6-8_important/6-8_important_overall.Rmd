...
df<-df[!dfe_phase %in% "Secondary"
             ...
             ][,`q3_important_I dont know`:=ifelse(is.na(`q3_important_I dont know`) & grepl("I dont know",q3_important),"Yes",ifelse(is.na(`q3_important_I dont know`),"No",`q3_important_I dont know`))
               ...
               ][,`q3_important_Starting my own family`:=ifelse(grepl("Starting a family of my own",q3_important),"Yes",ifelse(is.na(`q3_important_Starting my own family`),"No",`q3_important_Starting my own family`))]
